...
def draw_score(score_one, score_two):
    text_one = schriftart.render(f"Score:{score_one}", True, (255, 0, 0))
    screen.blit(text_one, (620, 10))

    text_two = schriftart.render(f"Score:{score_two}", True, (0, 0, 255))
...
while run:
    ...
    boddy_one = pygame.draw.rect(screen, (weiss), (10, yposition_one, 20, 100))
    boddy_two = pygame.draw.rect(screen, (weiss), (770, yposition_two, 20, 100))
